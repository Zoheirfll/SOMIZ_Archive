...
from employees.referentiel_views import (
    ...
    MotifArchivageListCreateView, MotifArchivageDetailView,
    TypeDocumentListCreateView, TypeDocumentDetailView,
    TypeDocumentReorderView,
    ChampPersonnaliseListCreateView, ChampPersonnaliseDetailView,
    ChampPersonnaliseOptionListCreateView, ChampPersonnaliseOptionDetailView,
...
urlpatterns = [
    ...
    path('motifs-archivage/', MotifArchivageListCreateView.as_view()),
    path('motifs-archivage/<uuid:pk>/', MotifArchivageDetailView.as_view()),
    path('types-documents/', TypeDocumentListCreateView.as_view()),
    path('types-documents/reorder/', TypeDocumentReorderView.as_view()),
    ...
    path('champs-personnalises/<uuid:champ_id>/options/', ChampPersonnaliseOptionListCreateView.as_view()),
    path('champs-personnalises/options/<uuid:pk>/', ChampPersonnaliseOptionDetailView.as_view()),
